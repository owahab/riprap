# riprap Individual Contributor License Agreement

Thank you for your interest in contributing to riprap ("We" or "Us").

This contributor agreement ("Agreement") documents the rights granted by contributors to Us. To
make this document effective, please sign it by checking the acknowledgement box in the pull
request template, following the instructions in [CONTRIBUTING.md](CONTRIBUTING.md). This is a
legally binding document, so please read it carefully before agreeing to it. The Agreement may
cover more than one software project managed by Us.

> **Why this exists, in plain words.** riprap is source-available under the
> [PolyForm Perimeter 1.0.1](LICENSE) license, and We intend to keep the option of offering a
> commercial edition later. Section 2.3 below is the clause that makes that possible, and it is
> Option Five of the standard Harmony agreement — chosen deliberately, and stated openly, rather
> than left to be inferred from silence. In exchange, Section 2.3 binds Us to also keep your
> contribution available under whatever license riprap itself carries on the day you send it.
> You keep ownership of your work and may use it anywhere else, for anything, forever.
...
### 2.7 Enforcement Authorization

You authorize Us to enforce, in Our own name and at Our own expense, the license terms under which
the Material is made available, against any third party, including with respect to Your
Contribution as incorporated in the Material. You are under no obligation to participate in or
fund any such enforcement, and nothing in this section obliges Us to enforce anything, transfers
ownership of Your Contribution, or limits Your own right to enforce Your Copyright.
...
approve this Agreement. If You are less than eighteen years old, please have Your parents or
guardian sign the Agreement.

(d) You have followed the instructions in [CONTRIBUTING.md](CONTRIBUTING.md), if You do not own
...
DISCLAIMED BY YOU TO US. TO THE EXTENT THAT ANY SUCH WARRANTIES CANNOT BE DISCLAIMED, SUCH
...
the State of Delaware, USA excluding its conflicts of law provisions. Under certain circumstances, the
...
Outbound License Option Five selected; Section 2.7 added.
